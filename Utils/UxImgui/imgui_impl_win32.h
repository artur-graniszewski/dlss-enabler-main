...
IMGUI_IMPL_API void     UxImGui_ImplWin32_Shutdown();
IMGUI_IMPL_API void     UxImGui_ImplWin32_NewFrame();
...
#if 0
extern IMGUI_IMPL_API LRESULT UxImGui_ImplWin32_WndProcHandler(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
#endif
...
IMGUI_IMPL_API void     UxImGui_ImplWin32_EnableDpiAwareness();
IMGUI_IMPL_API float    UxImGui_ImplWin32_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
IMGUI_IMPL_API float    UxImGui_ImplWin32_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
IMGUI_IMPL_API void     UxImGui_ImplWin32_EnableAlphaCompositing(void* hwnd);   // HWND hwnd
